...
class PostgresDB:
    ...
    def execute_query(self, query, params=None):
        ...
        try:
            with self.connection.cursor() as cursor:
                ...
                # Commit the changes for DML (INSERT, UPDATE, DELETE)
    ...
    def split_results(self, table_name, group_count):
        """
        Split results from a database table evenly among groups and save them as CSV files.
...
db = PostgresDB("localhost","5433","XAI Results", "postgres","2002")
db.connect()
db.split_results('runresults', group_count=3)
db.close()
